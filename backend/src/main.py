...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://frontend-client.onrender.com",  # Production frontend on Render (original name)
        "https://frontend-client-ftwt.onrender.com",  # Production frontend on Render (actual URL)
    ],
